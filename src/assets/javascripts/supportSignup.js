...
function SupportSignup() {
    // Step 1: Set Up State
    const usStates = ["AK - Alaska", "AL - Alabama", "AR - Arkansas", "AS - American Samoa", "AZ - Arizona", "CA - California", "CO - Colorado", 
    ...
    "ME - Maine", "MI - Michigan", "MN - Minnesota", "MO - Missouri", "MS - Mississippi", "MT - Montana", "NC - North Carolina", "ND - North Dakota", 
                    ...
                    <div onSubmit={handleSubmit}>
                        <form className="row">
                            <div className="col" id=''>
                                ...
                                <input name='companyname' onChange={handleUserChange} type="text" id='companyname' className="form-control"></input>
                            </div>
                        </form>
                        <form className='row'>
                            <div className="col">
                                <label className="form-label">Main Contact</label>
                                <input name='maincontact' value={password} onChange={handlePasswordChange} type="password" className="form-control" id="maincontact"></input>
                            </div>
                        </form>
                        <form className='row'>
                            <div className="col">
                                <label className="form-label">Contact Email</label>
                                <input name='contactemail' value={password} onChange={handlePasswordChange} type="password" className="form-control" id="contactemail"></input>
                            </div>
                        </form>
                        <form className='row'>
                            <div className="col">
                                <label className="form-label">Contact Phone with Area Code</label>
                                <input name='contactphone' value={password} onChange={handlePasswordChange} type="password" className="form-control" id="password"></input>
                            </div>
                        </form>
                        <form className='row'>
                            <div className="col">
                                <label className="form-label">City</label>
                                <input name='contactcity' value={password} onChange={handlePasswordChange} type="password" className="form-control" id="password"></input>
                            </div>
                        </form>
                        <form className='row'>
                            <div className="col">
                            ...
                            <div className="dropdown" style={{ width: '200px' }}>
                                <button id="dropdownButton" className="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    {selectedState}
                                </button>
                                <ul className="dropdown-menu" style={{ maxHeight: '150px', overflowY: 'auto' }}>
                                    {usStates.map((state) => <li key={state}><a className='dropdown-item' onClick={() => handleStateSelect(state)}>{state}</a></li> )}
                                </ul>
                                </div>
                            </div>
                        </form>
                        ...
                        <form className='row'>
                            <div className="col">
                                <label className="form-label">Main Format</label>
                                <input name='password' value={password} onChange={handlePasswordChange} type="password" className="form-control" id="password"></input>
                            </div>
                        </form>
                        ...
                        <form className='row'>
                            <div className="col">
                                <button type="submit" className="btn" style={{backgroundColor: 'red', color: 'white'}}>Sign up</button>
